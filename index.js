  ...
  if (message.content === 'z!yardım') {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '📌 Prefix Komutlar (-)', value: '`-invite` - Invite sistemi\n`-kanal kilitle` - Kanalı kilitle\n`-kanal aç` - Kanalı aç\n`-kanal sıfırla` - Kanalı sıfırla\n`-rolver @user @role` - Rol ver (Sadece Umut Papa)\n`-rolal @user @role` - Rol al (Sadece Umut Papa)', inline: false },
